...
net = cv2.dnn.readNetFromDarknet("/home/ubuntu/han/yolov4-tiny-custom_3th.cfg",r"yolov4-tiny-custom_3th.weights")
...
while 1:
    ...
    #result, imgencode = cv2.imencode('.jpg', img1, encode_param)
