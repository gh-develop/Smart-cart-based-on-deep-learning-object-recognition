...
public class MonitoringActivity extends Activity implements MonitorNotifier {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (BeaconReferenceApplication.insideRegion) {
            ...
            Intent myIntent3 = new Intent(this, ShopActivity2.class);
    ...
    public void didEnterRegion(Region region) { logToDisplay("didEnterRegion called");
        Intent myIntent2 = new Intent(this, ShopActivity2.class);
    ...
    public void onRangingClicked(View view) {
        Intent myIntent = new Intent(this, ShopActivity2.class);
        this.startActivity(myIntent);
    }
    public void onEnableClicked(View view) {
        // This is a toggle.  Each time we tap it, we start or stop
        Button button = (Button) findViewById(R.id.enableButton1);
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                EditText editText = (EditText)MonitoringActivity.this
                        .findViewById(R.id.monitoringText1);
